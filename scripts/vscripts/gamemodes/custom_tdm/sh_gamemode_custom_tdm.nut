        ...
        case "mp_rr_desertlands_64k_x_64k_nx":
            ...
            Shared_RegisterLocation(
                NewLocationSettings(
                    "TowerBig",
                    [
                        NewLocPair(< -22152.58, 12848.10, -3704.02>, < -1.44, 37.65, -0.00>),
                        NewLocPair(< -22402.87, 13267.77, -3703.89>, <5.26, 0.48, -0>),
                        NewLocPair(< -22245.95, 11629.23, -3553.97>, <1.35, 1.38, -0>),    
                        NewLocPair(< -22556.03, 11758.49, -3553.97>, <5.32, 11.43, -0>),    
                        NewLocPair(< -21623.67, 11530.90, -3704.14>, < -4.66, 4.66, 37.62>),   
                        NewLocPair(< -22273.92, 1158.04, -3673.57>, < -2.31, 43.79, -0>),     
                        NewLocPair(< -19815.26, 10371.41, -3505.97>, <1.59, 79.05, -0>),
                        NewLocPair(< -20166.74, 10345.99, -3577.97>, <1.98, 100.94, -0>),
                        NewLocPair(< -19027.58, 9462.74, -3331.94>, <2.01, 85.26, -0>),
                        NewLocPair(< -18883.93, 9711.42, 3286.77>, <5.65, 93.89, -0>),
                        NewLocPair(< -18042.94, 10294.85, -3703.95>, <2.34, 134.03, -0>),
                        NewLocPair(< -1733.42, 11225.10, -3711.54>, < -0.48, 145.72, -0>),
                        NewLocPair(< -18223.53, 11430.34, -3704.14>,  <1.06, 154.44, -0>),
                        NewLocPair(< -17218.11, 12106.22, -3393.52>, <0.12, 171.69, -0>),
                        NewLocPair(< -17107.78, 12737.54, -3699.97>, < -1.78, 155.39, -0>),
                        NewLocPair(< -18211.47, 13967.04, -3687.14>, < -3.40, -141.75, -0>),
                        NewLocPair(< -18346.43, 13672.52, -3538.99>, <2.11, -168.69, -0>),
                        NewLocPair(< -18631.32, 14463.50, -3601.02>, <0.37, 174.25, -0>),
                        NewLocPair(< -20178.23, 15006.10, -3702.81>, < -2.84, -90.91, -0>),
                        NewLocPair(< -21042.13, 15056.91, -3449.76>, <0.80, -66.33, -0>),
                        NewLocPair(< -20761.47, 13973.07, -3704.19>, <1.33, -47.79, -0>),
                        NewLocPair(< -20524.98, 13938.70, -3704.22>, < -0.52, -55.53, -0>),
                        NewLocPair(< -19755.26, 11519.04, -3704.17>, <3.03, 104.27, -0>)
                    ],
                    <0,0,3000>
                    )
                )
...
float function Deathmatch_GetRespawnDelay()                          { return GetCurrentPlaylistVarFloat("respawn_delay", 1) }
